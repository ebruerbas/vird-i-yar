# Vird Diyarı — App Store Metinleri

App Store Connect'te ilgili alanlara aynen kopyalanabilir.
...
```
Esma, Ayet, Dua ve Vakitler
```

## Anahtar Kelimeler (100 karakter, virgülle)

```
esmaül hüsna,dua,zikir,tesbih,namaz vakitleri,ezan,kıble,kuran,ayet,vird,tesbihat,sabah akşam
```

## Tanıtım Metni (Promotional Text, 170 karakter)

```
99 Esma, Kur'an'dan 97 ayet ve dua, sayaçlı tesbihat, namaz vakitleri, kıble pusulası ve ezan bildirimi — hepsi sade ve huzurlu tek bir uygulamada.
```

## Açıklama (Description)

```
Vird Diyarı; günlük zikir, dua ve ibadet hayatınıza eşlik etmek için özenle hazırlanmış, sade ve huzurlu bir uygulamadır.

ESMAÜL HÜSNA — 99 GÜZEL İSİM
Her esma; Arapça yazılışı, anlamı, ebced değeri, fazilet notları ve geçtiği ayet referanslarıyla birlikte sunulur. Her gün ana sayfada farklı bir esma sizi karşılar.

KUR'AN'DAN AYETLER VE DUALAR
Âyetel Kürsî'den Kur'an'da geçen peygamber dualarına 97 seçme ayet; günlük dualar ve tesbihat ile birlikte. Her içerikte Arapça metin, Latin okunuş, meal, fazilet notları ve kaynaklar yer alır.

SAYAÇLI ZİKİR
Her esma, ayet ve dua için hedefli zikir sayacı. Namaz sonrası tesbihat gibi kademeli virdlerde sayaç adım adım ilerler; titreşimle geri bildirim verir.

NAMAZ VAKİTLERİ VE KIBLE
...
- Gizlilik Politikası: `https://ebruerbas.github.io/vird-i-yar/privacy.html`
- Destek URL: `https://github.com/ebruerbas/vird-i-yar`

---

## İngilizce (isteğe bağlı ek yerelleştirme)

**Subtitle:** `Names, Verses, Duas & Prayer`

**Description (kısa):**

```
Vird Diyarı is a serene daily companion for dhikr and prayer: the 99 Names of Allah with meanings and sources, 97 selected Quranic verses and prayers with Arabic text, transliteration and translation, a tally counter for daily adhkar, prayer times for Türkiye with a live countdown, qibla compass, and adhan notifications computed on your device. No account, no ads, no data collection.
```
